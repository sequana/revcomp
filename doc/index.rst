Sequana revcomp pipeline documentation
#####################################################

|version|, |today|, status: production

The **revcomp** pipeline is a `Sequana <https://github.com/sequana/sequana>`_ pipeline. You can find the source code 
on  `https://github.com/sequana/sequana_revcomp <https://github.com/sequana/sequana_revcomp/>`_. Would you have issues
